...
## Houmao Vendored Test Fixture

This tree is vendored into Houmao as a realistic codebase for long-horizon agent testing. Houmao tracks these files directly; this directory is not a Git submodule and contains no nested `.git` metadata.

- Upstream source: <https://github.com/mahmoud/boltons>
- Upstream branch: `master`
- Imported revision: `979fa9b613fa8c0a455ae16ea6f2ec91c11ecafe`
- Imported on: `2026-07-13`

To refresh the fixture, replace this tree from the upstream source, remove the downloaded repository's `.git` metadata, preserve this notice, and update the imported revision and date.
