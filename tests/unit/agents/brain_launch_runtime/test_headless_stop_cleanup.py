...
from gig_agents.agents.brain_launch_runtime.backends.codex_headless import (
...
def test_headless_terminate_force_cleanup_kills_tmux(
    ...
    monkeypatch.setattr(
        "gig_agents.agents.brain_launch_runtime.backends.headless_base.kill_tmux_session_shared",
