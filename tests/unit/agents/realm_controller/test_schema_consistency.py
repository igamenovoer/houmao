...
from houmao.agents.realm_controller.registry_models import LiveAgentRegistryRecordV1
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("live_agent_registry_record.v1.schema.json", LiveAgentRegistryRecordV1),
    ],
)
def test_packaged_schema_matches_pydantic_model(
    ...
    model: (
        ...
        | type[SessionManifestPayloadV2]
        | type[LiveAgentRegistryRecordV1]
    ),
) -> None:
