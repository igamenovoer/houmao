# mailbox-roundtrip-real-agent-autotest Specification

## Purpose
Document the canonical pack-local real-agent autotest coverage for the mailbox roundtrip tutorial pack.
