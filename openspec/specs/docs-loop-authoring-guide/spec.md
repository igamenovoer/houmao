...
## Purpose
Define the documentation requirements for the Houmao loop authoring getting-started guide — a page that helps readers choose a loop skill, understand the pairwise-v2 routing-packet model, and discover graph tooling that supports plan authoring.
