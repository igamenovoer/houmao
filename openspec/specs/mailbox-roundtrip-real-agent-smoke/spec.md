# mailbox-roundtrip-real-agent-smoke Specification

## Purpose
Define the opt-in manual smoke lane that validates the mailbox roundtrip tutorial pack against actual local Claude and Codex CLIs.
