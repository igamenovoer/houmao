# Long-Horizon TUI Tracking Qualification Specification

## Purpose
Defines the reproducible long-horizon workflow used to qualify TUI state tracking across maintained providers, procedures, capture cadences, and downstream safety invariants.
