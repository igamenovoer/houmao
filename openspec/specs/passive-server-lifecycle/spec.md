...
Define the server lifecycle contract for `houmao-passive-server`: health check, current-instance metadata, graceful shutdown, configuration model, CLI entrypoint, and startup/shutdown bookkeeping.
