# agents-join-demo-pack Specification

## Purpose
Define the repository requirements for the `scripts/demo/agents-join-demo-pack/` workflow that teaches and validates managed adoption through `houmao-mgr agents join`.
