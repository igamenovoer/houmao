# auth-profile-rename Specification

## Purpose
Define the stable-identity contract for renaming project-local auth profiles without changing their underlying bundle references or auth content.
