# TUI Readiness Regression Qualification Specification

## Purpose
TBD - created by archiving change fix-codex-kimi-readiness-classification. Update Purpose after archive.
