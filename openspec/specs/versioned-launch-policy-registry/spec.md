...
- top-level `tool`
- one or more strategy entries with `strategy_id`, `operator_prompt_mode`, `backends`, and `version_range`
...
- **AND WHEN** those versions match different compatible strategy ranges
