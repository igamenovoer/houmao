## Purpose
Define the shared parser-stack contract for version-aware TUI parsing, projection handling, and direct tmux-capture integrations that reuse the same parser boundary.
