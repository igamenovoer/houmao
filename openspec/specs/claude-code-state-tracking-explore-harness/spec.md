# claude-code-state-tracking-explore-harness Specification

## Purpose
Define the external Claude Code state-tracking explore harness, including live tmux capture, content-first groundtruth, independent ReactiveX replay, comparison reporting, and maintained signal discovery artifacts.
