...
The active-thread polling effect SHALL start when at least one eligible pane is interested in that gateway and SHALL stop when no pane remains interested.
