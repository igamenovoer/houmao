...
## Purpose
Define the canonical direct `houmao-server` managed-agent API validator as a self-contained demo pack with stepwise, unattended, and HTT validation surfaces.
