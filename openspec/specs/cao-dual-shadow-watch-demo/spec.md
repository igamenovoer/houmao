# cao-dual-shadow-watch-demo Specification

## Purpose
Define the standalone dual shadow-watch demo pack for live side-by-side validation of Claude Code and Codex `shadow_only` parser and lifecycle behavior.
