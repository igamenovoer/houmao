# owned-path-mutation-safety Specification

## Purpose
Define baseline safety requirements for destructive mutations of Houmao-owned paths and caller-provided source paths.
