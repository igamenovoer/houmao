...
**Reason**: The previous rule did not define how actor identity satisfies or constrains system targets.
**Migration**: Use the actor-preserving direct-operation question contract.

### Requirement: Shared guidance covers direct and guided Houmao system questions
**Reason**: Guided questions now belong to the standalone admin welcome, while executable questions belong to actor-qualified routes.
**Migration**: Keep separate direct-operation and welcome question contracts with context-preserving handoff.
