...
- Persist and restore multi-group Dockview layouts for restorable tmux-backed tabs, while continuing to skip non-restorable shell tabs on reload.
...
- Systems: browser-side workspace persistence, xterm fitting/resizing, active-session routing for tmux and keyboard controls
