...
Gemini is intentionally out of the maintained v1 contract here. The backend exists, but this demo only claims lanes with an explicit unattended headless launch posture today.
