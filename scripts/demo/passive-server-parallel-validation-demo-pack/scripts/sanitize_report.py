#!/usr/bin/env python3
"""Sanitize one passive-server parallel validation report for reproducible verification."""
...
from houmao.demo.passive_server_parallel_validation_demo_pack.reporting import sanitize_report
