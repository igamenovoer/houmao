#!/usr/bin/env python3
"""Sanitize gateway wake-up demo reports for reproducible comparison."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Sanitize gateway wake-up demo report output")
