...
payload = {
    ...
    "artifact_refs": {
        ...
        "sanitized_report_path": str(output_root / "report.sanitized.json"),
        "inspect_phase_path": str(output_root / "control" / "phases" / "inspect" / "result.json"),
        "stop_phase_path": str(output_root / "control" / "phases" / "stop" / "result.json"),
    },
}
