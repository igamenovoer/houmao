#!/usr/bin/env python3
"""Verify or snapshot the sanitized mail ping-pong demo report."""
...
from houmao.demo.legacy.mail_ping_pong_gateway_demo_pack.reporting import verify_sanitized_report


def main() -> int:
    """Run the verification CLI."""

    parser = argparse.ArgumentParser(description="Verify mail ping-pong demo report contract")
