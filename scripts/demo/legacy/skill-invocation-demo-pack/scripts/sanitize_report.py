#!/usr/bin/env python3
"""Sanitize skill-invocation demo reports for reproducible comparison."""
...
from tutorial_pack_helpers import sanitize_report


def main() -> int:
    """Run the sanitizer CLI."""

    parser = argparse.ArgumentParser(description="Sanitize skill-invocation demo report output")
