#!/usr/bin/env python3
"""Verify or snapshot the sanitized skill-invocation demo report."""
...
from tutorial_pack_helpers import verify_sanitized_report


def main() -> int:
    """Run the verification CLI."""

    parser = argparse.ArgumentParser(description="Verify skill-invocation demo report contract")
