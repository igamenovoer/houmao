#!/usr/bin/env python3
"""Verify or snapshot the sanitized TUI mail gateway demo report."""
...
from houmao.demo.legacy.tui_mail_gateway_demo_pack.reporting import verify_sanitized_report


def main() -> int:
    """Run the verification CLI."""

    parser = argparse.ArgumentParser(description="Verify TUI mail gateway demo report contract")
