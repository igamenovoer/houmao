...
5. **Submit the exact stimulus once through its frozen origin.** A manual driving prompt includes its exact skill handle, an automatic driving prompt contains no skill handle, and generated or lifecycle stimuli use their maintained authority. Preserve whitespace and qualifiers and do not include oracle hints, expected skill names beyond the stimulus, or evaluator commentary.
