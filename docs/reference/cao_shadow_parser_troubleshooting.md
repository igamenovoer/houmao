...
- Success path: attach using the returned `tmux_session_name` (for example `tmux attach -t AGENTSYS-gpu-1760000123456`), and `tmux list-windows -t <tmux_session_name>` shows only the agent window.
