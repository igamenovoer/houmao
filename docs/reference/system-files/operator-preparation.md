...
| `<registry-root>/live_agents/<agent-id>/record.json` | Let the runtime or `houmao-mgr admin cleanup registry` manage freshness; do not treat fresh live entries as scratch |
