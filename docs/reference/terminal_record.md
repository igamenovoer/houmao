...
- `pane_snapshots.ndjson`: exact tmux pane samples captured with `tmux capture-pane`; this is the authoritative replay surface
...
- `state_observed.ndjson`: lifecycle/state-tracker observations generated by `analyze`
