...
- [Project-Aware Operations](operations/project-aware-operations.md): How commands resolve the active `.houmao/` project overlay for agent definitions, runtime, and mailbox roots.
