...
| Gemini | `.gemini/skills/` | Namespaced under `mailbox/`. |

Claude receives mailbox skills as first-class top-level skills because Claude Code has native SKILL.md support. Other tools use the `mailbox/` namespace prefix to avoid collisions with user-defined skills.
