...
- [`src/houmao/agents/assets/system_skills/protected/houmao-shared-routines/subskills/houmao-agent-email-comms/references/filesystem-layout.md`](../../../../src/houmao/agents/assets/system_skills/protected/houmao-shared-routines/subskills/houmao-agent-email-comms/references/filesystem-layout.md)
