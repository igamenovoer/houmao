...
- Gemini uses top-level Houmao skill directories under `.gemini/skills/`, such as `.gemini/skills/houmao-email-via-agent-gateway/SKILL.md`, instead of namespaced compatibility subtrees.
