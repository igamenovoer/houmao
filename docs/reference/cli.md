...
- `system-skills` installs, removes, and inspects Houmao-owned skills for resolved Claude, Codex, Kimi Code, Gemini, or Copilot homes outside managed launch or join, and for the cross-client `universal` target under `~/.agents/skills`
