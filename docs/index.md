...
- [System Skills Overview](getting-started/system-skills-overview.md): Narrative tour of the ten packaged Houmao-owned system skills, when each one fires, and how managed-home auto-install differs from explicit CLI-default install.
