import type { NormalizedAgUiTarget, TargetConfig } from "../ag-ui/types";
...
export function normalizeAgUiTarget(config: TargetConfig): NormalizedAgUiTarget {
  return normalizeAgUiTargetUrl(config.url);
}

export function normalizeAgUiTargetUrl(value: string): NormalizedAgUiTarget {
