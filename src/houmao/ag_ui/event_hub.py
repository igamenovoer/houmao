"""In-memory fanout for agent-published AG-UI events."""
...
class AgUiEventHub:
    """Bounded in-memory fanout for AG-UI events published to one gateway."""
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize an empty fanout hub."""
    ...
    def publish(
        ...
        *,
        ...
        """Publish events to matching active subscriptions and return delivery count."""
...
__all__ = ["AgUiEventHub", "AgUiEventSubscription"]
