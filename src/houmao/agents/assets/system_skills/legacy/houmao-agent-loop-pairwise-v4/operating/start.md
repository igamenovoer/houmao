...
Started pairwise-v4 runs create or refresh one runtime-owned recovery record for that logical run:
...
- Do not treat acknowledgement replies as readiness blockers for pairwise-v4 `start`.
