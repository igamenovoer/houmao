...
Use this reference when a pairwise-v4 plan needs to record where participants are supposed to work, where they may write, and how standard versus custom workspace mode changes that contract.

## Modes

Every pairwise-v4 plan records one workspace contract:
