...
| --- | --- | --- | --- | --- |
| SC-001 | `<VERB>` | `<central | role | reporting | bookkeeping | routing>` | `<source rule>` | `<section or inline packet>` |
...
- durable continuation page namespace: <for example loop-runs/pairwise-v4/<run_id>/recover-and-continue.md>
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| SC-001 | `<source>` | `<VERB>` | `<scope>` | `<rule>` | `<plan.md section>` | `<packet, report, bookkeeping, or agent note section>` | `<covered | unresolved | excluded>` |
