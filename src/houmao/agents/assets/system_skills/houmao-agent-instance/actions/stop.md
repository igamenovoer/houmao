...
Use this action only when the user wants to stop one live managed agent. This remains the canonical general lifecycle stop action even though `houmao-specialist-mgr` may also front specialist-scoped easy-instance stop requests.
