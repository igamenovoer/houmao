...
Use this action when you need to identify the correct managed agent first or discover whether current gateway and mailbox follow-up surfaces are available.
