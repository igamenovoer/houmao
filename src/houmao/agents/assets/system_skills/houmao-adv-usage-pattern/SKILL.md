...
description: Use Houmao's advanced-usage pattern skill for supported multi-step workflow compositions such as self-notification and multi-agent relay loops built from existing Houmao skills.
license: MIT
---
