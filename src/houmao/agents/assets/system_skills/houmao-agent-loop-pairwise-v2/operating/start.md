...
12. If the accepted run needs live reminders or mailbox follow-up, let the master use `houmao-agent-gateway`, `houmao-agent-email-comms`, and the pairwise pattern in `houmao-adv-usage-pattern`.
