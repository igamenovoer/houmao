...
- `prepare-workspace` adapts generated workspace contracts, agent bindings, and prepared agent/profile facts into `houmao-shared-routines->houmao-utils-workspace-mgr` `plan`, `create`, `validate`, or `summarize` inputs.
