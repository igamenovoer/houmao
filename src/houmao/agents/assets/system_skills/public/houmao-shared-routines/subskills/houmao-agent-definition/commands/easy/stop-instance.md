...
- Use this subskill for the project stop entry point. General live-agent stop belongs to `houmao-shared-routines->houmao-agent-instance`.
...
5. Tell the user that broader live-agent lifecycle management belongs to `houmao-shared-routines->houmao-agent-instance`.
