...
- Actor-scoped mailbox participation belongs to `houmao-shared-routines->houmao-agent-email-comms`.
- Notifier-driven open-mail rounds belong to `houmao-shared-routines->houmao-process-emails-via-gateway`.
