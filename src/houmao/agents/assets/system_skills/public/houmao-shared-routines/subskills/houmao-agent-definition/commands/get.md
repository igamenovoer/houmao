...
7. If the user asks to inspect env vars or auth files inside one auth bundle, stop and route that request to `houmao-shared-routines->houmao-credential-mgr`.
