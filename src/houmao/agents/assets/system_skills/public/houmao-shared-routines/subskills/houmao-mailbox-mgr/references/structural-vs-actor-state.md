...
Use `houmao-shared-routines->houmao-agent-email-comms` and the maintained `houmao-mgr agents self mail ...` or `houmao-mgr agents single ... mail ...` surfaces when the task is about:
