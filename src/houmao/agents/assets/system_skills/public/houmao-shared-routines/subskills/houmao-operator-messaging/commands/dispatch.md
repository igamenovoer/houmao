...
- Use `houmao-shared-routines->houmao-agent-messaging` ordinary prompt behavior for prompt packets.
...
- Use `houmao-shared-routines->houmao-agent-messaging`.
...
- Use `houmao-shared-routines->houmao-agent-email-comms`.
