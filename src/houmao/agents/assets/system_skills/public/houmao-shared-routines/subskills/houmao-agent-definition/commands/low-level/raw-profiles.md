# Launch Dossiers Compatibility Redirect
...
This retained filename exists for older installed skill references. For current guidance, read [launch-dossiers.md](launch-dossiers.md).
