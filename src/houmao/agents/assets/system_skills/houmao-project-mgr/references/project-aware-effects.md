...
- `houmao-mgr agents launch` uses the selected project as the source for preset or launch-profile resolution and overlay-local runtime, jobs, and mailbox defaults.
