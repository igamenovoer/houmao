...
- `houmao-agent-definition` for `project agents roles ...`, `project agents recipes ...`, explicit `project agents launch-profiles ...`, `project easy specialist ...`, `project easy profile ...`, and easy `project easy instance launch|stop`
