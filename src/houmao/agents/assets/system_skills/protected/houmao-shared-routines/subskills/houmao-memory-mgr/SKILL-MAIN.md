...
- `$<public-entrypoint> memory-mgr help`
- `$<public-entrypoint> memory-mgr show memo for <agent>`
- `$<public-entrypoint> memory-mgr append to <agent> memo`
- `$<public-entrypoint> memory-mgr set memo seed for profile <name>`

Related skills and boundaries:

- Use `<public-entrypoint>->houmao-shared-routines->agent-definition` for non-memory profile authoring.
- Use `<public-entrypoint>->houmao-shared-routines->agent-inspect` for runtime manifests, logs, screen, or mailbox posture.
- Use `<public-entrypoint>->houmao-shared-routines->agent-gateway` for reminders, not managed memory.
