...
4. If the request is generic read-only inspection rather than messaging preparation, hand it off to `<public-entrypoint>->houmao-shared-routines->agent-inspect`.
