...
- Do not run or invent a maintained Kimi login helper; use `../references/kimi-code-login-handling.md` for explicit Kimi Code OAuth login/import requests.
