...
- Do not use this action when the user wants to remove all delivered messages from the mailbox root; use `commands/clear-messages.md` for that all-account reset.
