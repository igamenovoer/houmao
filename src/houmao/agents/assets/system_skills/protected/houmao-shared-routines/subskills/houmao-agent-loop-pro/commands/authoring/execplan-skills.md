...
- route notifier posture to `<public-entrypoint>->houmao-shared-routines->agent-gateway`;
- route operator prompts to `<public-entrypoint>->houmao-shared-routines->agent-messaging`;
- route ordinary mail work to `<public-entrypoint>->houmao-shared-routines->agent-email-comms`;
