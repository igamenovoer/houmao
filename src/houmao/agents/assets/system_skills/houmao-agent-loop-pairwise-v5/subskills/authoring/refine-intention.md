...
Use this page when `<loop-dir>/intention/` already exists and the user wants to revise the loop source.
...
5. If an existing `execplan/` may now be stale, tell the user to run the v5 `regenerate-execplan` operation.
