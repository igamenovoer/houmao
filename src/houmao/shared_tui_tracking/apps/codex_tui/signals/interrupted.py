...
def interrupted_text_visible_in_lines(*, lines: Sequence[str]) -> bool:
    """Return whether the interrupted banner is visible inside one scoped line region."""
...
def is_interrupted_surface(
    *,
    latest_turn_lines: Sequence[str],
    prompt_visible: bool,
