...
- Treat ordinary mailbox work as a Houmao-owned workflow through gateway HTTP or scoped `houmao-mgr agents single/self ... mail ...`; do not treat `rules/scripts/` as the first-choice public execution contract.
